...
public class Activityenviados extends ActionBarActivity {
	private SharedPreferences pref;
	private String prefName = "Mypref";
	private String valcam2 = "usuario";
	ListView enviados; 
	ArrayAdapter<String> adapter;
	String enviados_url = "https://awakewind.000webhostapp.com/enviados.php";
	String line = null;
	String result = null;
	String[] data;
	InputStream is=null;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_activityenviados);
		enviados = (ListView)findViewById(R.id.listEnviados);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activityenviados, menu);
		return true;
	}
